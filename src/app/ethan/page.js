...
function Header() {
    return (
        <div className="flex flex-col gap-4 col-span-2 justify-between">
            <div className="gap-2">
                <h1 className="font-bold text-6xl">Ethan Gutierrez</h1>
                <p className="font-light text-4xl">Backend DevOps Engineer</p>
            </div>
            <Icons />
        </div>
    );
...
function Bio() {
    return (
        <div className="flex flex-col gap-4 justify-center items-center">
            <Image src="/ethan.jfif" width={200} height={200} alt="picture of myself" className="border-2 rounded-full" />
        </div>
    );
}
...
function Experience() {
    return (
        <div className="flex flex-col gap-4">
            ...
            <p className="font-bold text-xl">Backend DevOps at Firewave</p>
            <ul>
            ...
            <p className="font-bold text-xl">Instructor at the Coder School</p>
            <ul>
